...
from river.tests.hooking.base_static_hooking_test import BaseStaticHookingTest
from river.tests.models import BasicTestModel
from river.tests.models.factories import BasicTestModelObjectFactory


# noinspection DuplicatedCode
class StaticTransitionHookingTest(BaseStaticHookingTest):
    ...
    def test_shouldInvokeCallbackThatIsRegisteredWithInstanceWhenTransitionHappens(self):
        ...
        self.hook_post_transition(transition_meta_2, workflow_object=workflow_object.model)
        ...
        last_approval = TransitionApproval.objects.get(object_id=workflow_object.model.pk, transition__source_state=state2,
                                                       transition__destination_state=state3)
    ...
    def test_shouldInvokeCallbackThatIsRegisteredWithoutInstanceWhenTransitionHappens(self):
        ...
        self.hook_post_transition(transition_meta_2)
    ...
    def test_shouldInvokeCallbackForTheOnlyGivenTransition(self):
        ...
        self.hook_pre_transition(transition_meta_1, transition=transition_meta_1.transitions.first())
