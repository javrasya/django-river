...
class TransitionHooking(BaseTestCase):
    ...
    def test_register_for_a_transition_on_an_object(self):
        self.initialize_standard_scenario()
    ...
    def test_register_for_a_transition_on_the_class(self):
        self.initialize_standard_scenario()
        ...
        TestModel.river.my_field.hook_post_transition(test_callback, source_state=self.state2, destination_state=self.state3)
