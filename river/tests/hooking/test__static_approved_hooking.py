...
class StaticApprovedHooking(BaseStaticHookingTest):
    ...
    def test_shouldInvokeCallbackThatIsRegisteredWithInstanceWhenAnApprovingHappens(self):
        ...
        self.hook_pre_approve(meta1, workflow_object=workflow_object.model)
    ...
    def test_shouldInvokeCallbackForTheOnlyGivenApproval(self):
        ...
        self.hook_pre_approve(meta1, transition_approval=first_approval)
