    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_track', mptt.fields.TreeOneToOneField(on_delete=models.CASCADE, related_name='next_track', null=True, blank=True, to='river.ProceedingTrack', verbose_name='Previous track')),
                ('proceeding', models.ForeignKey(on_delete=models.CASCADE, related_name='tracks', verbose_name='Proceeding', to='river.Proceeding')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Content Type', to='contenttypes.ContentType')),
                ('destination_state', models.ForeignKey(on_delete=models.CASCADE, related_name='transitions_as_destination', verbose_name='Next State', to='river.State')),
                ('source_state', models.ForeignKey(on_delete=models.CASCADE, related_name='transitions_as_source', verbose_name='Source State', to='river.State')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='transition',
            field=models.ForeignKey(on_delete=models.CASCADE, verbose_name='Transition', to='river.Transition'),
        ),
        migrations.AddField(
            model_name='proceeding',
            name='meta',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='proceedings', verbose_name='Meta', to='river.ProceedingMeta'),
        ),
        migrations.AddField(
            model_name='proceeding',
            name='permissions',
        ...
        migrations.AddField(
            model_name='proceeding',
            name='transactioner',
            field=models.ForeignKey(on_delete=models.CASCADE, verbose_name='Transactioner', blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
